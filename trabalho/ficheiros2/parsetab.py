...
_lr_productions = [
  ...
  ('programa -> programa etiqueta instrucao','programa',3,'p_programa','registos.py',217),
  ('programa -> <empty>','programa',0,'p_prgram_empty','registos.py',223),
  ('etiqueta -> IDENTIFICADOR DOIS_PONTOS','etiqueta',2,'p_etiqueta','registos.py',229),
  ('etiqueta -> <empty>','etiqueta',0,'p_etiqueta_empty','registos.py',236),
  ('instrucao -> ADD','instrucao',1,'p_instrucao','registos.py',241),
  ('instrucao -> SUB','instrucao',1,'p_instrucao','registos.py',242),
  ('instrucao -> MULT','instrucao',1,'p_instrucao','registos.py',243),
  ('instrucao -> DIV','instrucao',1,'p_instrucao','registos.py',244),
  ('instrucao -> MOD','instrucao',1,'p_instrucao','registos.py',245),
  ('instrucao -> EXP','instrucao',1,'p_instrucao','registos.py',246),
  ('instrucao -> RETURN','instrucao',1,'p_instrucao','registos.py',247),
  ('instrucao -> PRINT','instrucao',1,'p_instrucao','registos.py',248),
  ('instrucao -> PRINT_NL','instrucao',1,'p_instrucao','registos.py',249),
  ('instrucao -> COMENTARIO','instrucao',1,'p_instrucao','registos.py',250),
  ('instrucao -> PUSH_INT INTEIRO','instrucao',2,'p_instrucao_arg1','registos.py',257),
  ('instrucao -> SET_ARG INTEIRO','instrucao',2,'p_instrucao_arg1','registos.py',258),
  ('instrucao -> JUMP IDENTIFICADOR','instrucao',2,'p_instrucao_arg1','registos.py',259),
  ('instrucao -> JEQ IDENTIFICADOR','instrucao',2,'p_instrucao_arg1','registos.py',260),
  ('instrucao -> JLT IDENTIFICADOR','instrucao',2,'p_instrucao_arg1','registos.py',261),
  ('instrucao -> PRINT_STR STRING','instrucao',2,'p_instrucao_arg1','registos.py',262),
  ('instrucao -> PUSH_VAR INTEIRO INTEIRO','instrucao',3,'p_instrucao_arg2','registos.py',269),
  ('instrucao -> PUSH_ARG INTEIRO INTEIRO','instrucao',3,'p_instrucao_arg2','registos.py',270),
  ('instrucao -> STORE_VAR INTEIRO INTEIRO','instrucao',3,'p_instrucao_arg2','registos.py',271),
  ('instrucao -> STORE_ARG INTEIRO INTEIRO','instrucao',3,'p_instrucao_arg2','registos.py',272),
  ('instrucao -> CALL INTEIRO IDENTIFICADOR','instrucao',3,'p_instrucao_arg2','registos.py',273),
  ('instrucao -> LOCALS INTEIRO INTEIRO','instrucao',3,'p_instrucao_arg2','registos.py',274),
]
