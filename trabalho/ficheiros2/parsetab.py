...
_lr_productions = [
  ...
  ('programa -> programa etiqueta instrucao','programa',3,'p_programa','registos.py',12),
  ('programa -> <empty>','programa',0,'p_prgram_empty','registos.py',18),
  ('etiqueta -> IDENTIFICADOR DOIS_PONTOS','etiqueta',2,'p_etiqueta','registos.py',24),
  ('etiqueta -> <empty>','etiqueta',0,'p_etiqueta_empty','registos.py',31),
  ('instrucao -> ADD','instrucao',1,'p_instrucao','registos.py',36),
  ('instrucao -> SUB','instrucao',1,'p_instrucao','registos.py',37),
  ('instrucao -> MULT','instrucao',1,'p_instrucao','registos.py',38),
  ('instrucao -> DIV','instrucao',1,'p_instrucao','registos.py',39),
  ('instrucao -> MOD','instrucao',1,'p_instrucao','registos.py',40),
  ('instrucao -> EXP','instrucao',1,'p_instrucao','registos.py',41),
  ('instrucao -> RETURN','instrucao',1,'p_instrucao','registos.py',42),
  ('instrucao -> PRINT','instrucao',1,'p_instrucao','registos.py',43),
  ('instrucao -> PRINT_NL','instrucao',1,'p_instrucao','registos.py',44),
  ('instrucao -> COMENTARIO','instrucao',1,'p_instrucao','registos.py',45),
  ('instrucao -> PUSH_INT INTEIRO','instrucao',2,'p_instrucao_arg1','registos.py',52),
  ('instrucao -> SET_ARG INTEIRO','instrucao',2,'p_instrucao_arg1','registos.py',53),
  ('instrucao -> JUMP IDENTIFICADOR','instrucao',2,'p_instrucao_arg1','registos.py',54),
  ('instrucao -> JEQ IDENTIFICADOR','instrucao',2,'p_instrucao_arg1','registos.py',55),
  ('instrucao -> JLT IDENTIFICADOR','instrucao',2,'p_instrucao_arg1','registos.py',56),
  ('instrucao -> PRINT_STR STRING','instrucao',2,'p_instrucao_arg1','registos.py',57),
  ('instrucao -> PUSH_VAR INTEIRO INTEIRO','instrucao',3,'p_instrucao_arg2','registos.py',64),
  ('instrucao -> PUSH_ARG INTEIRO INTEIRO','instrucao',3,'p_instrucao_arg2','registos.py',65),
  ('instrucao -> STORE_VAR INTEIRO INTEIRO','instrucao',3,'p_instrucao_arg2','registos.py',66),
  ('instrucao -> STORE_ARG INTEIRO INTEIRO','instrucao',3,'p_instrucao_arg2','registos.py',67),
  ('instrucao -> CALL INTEIRO IDENTIFICADOR','instrucao',3,'p_instrucao_arg2','registos.py',68),
  ('instrucao -> LOCALS INTEIRO INTEIRO','instrucao',3,'p_instrucao_arg2','registos.py',69),
]
