...
_lr_productions = [
  ...
  ('programa -> programa etiqueta instrucao','programa',3,'p_programa','registos.py',155),
  ('programa -> <empty>','programa',0,'p_prgram_empty','registos.py',161),
  ('etiqueta -> IDENTIFICADOR DOIS_PONTOS','etiqueta',2,'p_etiqueta','registos.py',166),
  ('etiqueta -> <empty>','etiqueta',0,'p_etiqueta_empty','registos.py',172),
  ('instrucao -> ADD','instrucao',1,'p_instrucao','registos.py',177),
  ('instrucao -> SUB','instrucao',1,'p_instrucao','registos.py',178),
  ('instrucao -> MULT','instrucao',1,'p_instrucao','registos.py',179),
  ('instrucao -> DIV','instrucao',1,'p_instrucao','registos.py',180),
  ('instrucao -> MOD','instrucao',1,'p_instrucao','registos.py',181),
  ('instrucao -> EXP','instrucao',1,'p_instrucao','registos.py',182),
  ('instrucao -> RETURN','instrucao',1,'p_instrucao','registos.py',183),
  ('instrucao -> PRINT','instrucao',1,'p_instrucao','registos.py',184),
  ('instrucao -> PRINT_NL','instrucao',1,'p_instrucao','registos.py',185),
  ('instrucao -> COMENTARIO','instrucao',1,'p_instrucao','registos.py',186),
  ('instrucao -> PUSH_INT INTEIRO','instrucao',2,'p_instrucao_arg1','registos.py',192),
  ('instrucao -> SET_ARG INTEIRO','instrucao',2,'p_instrucao_arg1','registos.py',193),
  ('instrucao -> JUMP IDENTIFICADOR','instrucao',2,'p_instrucao_arg1','registos.py',194),
  ('instrucao -> JEQ IDENTIFICADOR','instrucao',2,'p_instrucao_arg1','registos.py',195),
  ('instrucao -> JLT IDENTIFICADOR','instrucao',2,'p_instrucao_arg1','registos.py',196),
  ('instrucao -> PRINT_STR STRING','instrucao',2,'p_instrucao_arg1','registos.py',197),
  ('instrucao -> PUSH_VAR INTEIRO INTEIRO','instrucao',3,'p_instrucao_arg2','registos.py',203),
  ('instrucao -> PUSH_ARG INTEIRO INTEIRO','instrucao',3,'p_instrucao_arg2','registos.py',204),
  ('instrucao -> STORE_VAR INTEIRO INTEIRO','instrucao',3,'p_instrucao_arg2','registos.py',205),
  ('instrucao -> STORE_ARG INTEIRO INTEIRO','instrucao',3,'p_instrucao_arg2','registos.py',206),
  ('instrucao -> CALL INTEIRO IDENTIFICADOR','instrucao',3,'p_instrucao_arg2','registos.py',207),
  ('instrucao -> LOCALS INTEIRO INTEIRO','instrucao',3,'p_instrucao_arg2','registos.py',208),
]
