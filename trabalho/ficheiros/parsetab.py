...
_lr_productions = [
  ...
  ('programa -> <empty>','programa',0,'p_prgram_empty','registos.py',162),
  ('etiqueta -> IDENTIFICADOR DOIS_PONTOS','etiqueta',2,'p_etiqueta','registos.py',167),
  ('etiqueta -> <empty>','etiqueta',0,'p_etiqueta_empty','registos.py',173),
  ('instrucao -> ADD','instrucao',1,'p_instrucao','registos.py',178),
  ('instrucao -> SUB','instrucao',1,'p_instrucao','registos.py',179),
  ('instrucao -> MULT','instrucao',1,'p_instrucao','registos.py',180),
  ('instrucao -> DIV','instrucao',1,'p_instrucao','registos.py',181),
  ('instrucao -> MOD','instrucao',1,'p_instrucao','registos.py',182),
  ('instrucao -> EXP','instrucao',1,'p_instrucao','registos.py',183),
  ('instrucao -> RETURN','instrucao',1,'p_instrucao','registos.py',184),
  ('instrucao -> PRINT','instrucao',1,'p_instrucao','registos.py',185),
  ('instrucao -> PRINT_NL','instrucao',1,'p_instrucao','registos.py',186),
  ('instrucao -> COMENTARIO','instrucao',1,'p_instrucao','registos.py',187),
  ('instrucao -> PUSH_INT INTEIRO','instrucao',2,'p_instrucao_arg1','registos.py',193),
  ('instrucao -> SET_ARG INTEIRO','instrucao',2,'p_instrucao_arg1','registos.py',194),
  ('instrucao -> JUMP IDENTIFICADOR','instrucao',2,'p_instrucao_arg1','registos.py',195),
  ('instrucao -> JEQ IDENTIFICADOR','instrucao',2,'p_instrucao_arg1','registos.py',196),
  ('instrucao -> JLT IDENTIFICADOR','instrucao',2,'p_instrucao_arg1','registos.py',197),
  ('instrucao -> PRINT_STR STRING','instrucao',2,'p_instrucao_arg1','registos.py',198),
  ('instrucao -> PUSH_VAR INTEIRO INTEIRO','instrucao',3,'p_instrucao_arg2','registos.py',204),
  ('instrucao -> PUSH_ARG INTEIRO INTEIRO','instrucao',3,'p_instrucao_arg2','registos.py',205),
  ('instrucao -> STORE_VAR INTEIRO INTEIRO','instrucao',3,'p_instrucao_arg2','registos.py',206),
  ('instrucao -> STORE_ARG INTEIRO INTEIRO','instrucao',3,'p_instrucao_arg2','registos.py',207),
  ('instrucao -> CALL INTEIRO IDENTIFICADOR','instrucao',3,'p_instrucao_arg2','registos.py',208),
  ('instrucao -> LOCALS INTEIRO INTEIRO','instrucao',3,'p_instrucao_arg2','registos.py',209),
]
